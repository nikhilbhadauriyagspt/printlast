        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 pt-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20">
                ...
                <div className="bg-white dark:bg-gray-900 shadow-xl rounded-2xl p-6 md:p-10 lg:p-12 border border-gray-200 dark:border-gray-800 prose prose-gray dark:prose-invert max-w-none prose-headings:font-bold prose-headings:text-gray-900 dark:prose-headings:text-white prose-a:text-blue-600 dark:prose-a:text-blue-400 hover:prose-a:underline prose-blockquote:border-l-4 prose-blockquote:border-gray-300 dark:prose-blockquote:border-gray-600 prose-blockquote:pl-4 prose-blockquote:italic">
                    ...
                    <p>
                        We are PrintLast ("Company," "we," "us," "our"), a company registered in Louisiana, United States at 8560 Florida Blvd, , Baton Rouge, LA 70815. We operate the website https://printlast.shop/ (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
                    </p>
                    <p>
                        At Printlast, we don't just sell printers as hardware. We provide the operational backbone that keeps your business running smoothly. From home offices to enterprise networks, we deliver tech that works.
                    </p>
                    <p>
                        You can contact us by phone at XXXXXXXXXX, email at <a href="mailto:printlast@outlook.com">printlast@outlook.com</a>, or by mail to 8560 Florida Blvd, , Baton Rouge, LA 70815, United States.
                    </p>
                    <p>
                        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and PrintLast, concerning your access to and use of the Services.
                    </p>
                    <p>
                    ...
                    <p>
                        Supplemental terms and conditions or documents that may be posted on the Services from t ime to time are hereby expressly incorporated herein by reference. We reserve the right, in our sole discretion, to make changes or modifications to these Legal Terms at any time and for any reason. We will alert you about any changes by updating the "Last updated" date of these Legal Terms, and you waive any right to receive specific notice of each such change.
                    </p>
                    <p>
                    ...
                    {/* TABLE OF CONTENTS */}
                    <h2 className="mt-16 text-3xl border-b border-gray-200 dark:border-gray-700 pb-4">
                        TABLE OF CONTENTS
                    </h2>

                    <ol className="mt-6 list-decimal pl-6 space-y-2.5 text-blue-700 dark:text-blue-300 text-base">
                        <li><a href="#sec1">OUR SERVICES</a></li>
                        <li><a href="#sec2">INTELLECTUAL PROPERTY RIGHTS</a></li>
                        <li><a href="#sec3">USER REPRESENTATIONS</a></li>
                        <li><a href="#sec4">USER REGISTRATION</a></li>
                        <li><a href="#sec5">PRODUCTS</a></li>
                        <li><a href="#sec6">PURCHASES AND PAYMENT</a></li>
                        <li><a href="#sec7">RETURN POLICY</a></li>
                        <li><a href="#sec8">PROHIBITED ACTIVITIES</a></li>
                        <li><a href="#sec9">USER GENERATED CONTRIBUTIONS</a></li>
                        <li><a href="#sec10">CONTRIBUTION LICENSE</a></li>
                        <li><a href="#sec11">GUIDELINES FOR REVIEWS</a></li>
                        <li><a href="#sec12">SERVICES MANAGEMENT</a></li>
                        <li><a href="#sec13">PRIVACY POLICY</a></li>
                        <li><a href="#sec14">TERM AND TERMINATION</a></li>
                        <li><a href="#sec15">MODIFICATIONS AND INTERRUPTIONS</a></li>
                        <li><a href="#sec16">GOVERNING LAW</a></li>
                        <li><a href="#sec17">DISPUTE RESOLUTION</a></li>
                        <li><a href="#sec18">CORRECTIONS</a></li>
                        <li><a href="#sec19">DISCLAIMER</a></li>
                        <li><a href="#sec20">LIMITATIONS OF LIABILITY</a></li>
                        <li><a href="#sec21">INDEMNIFICATION</a></li>
                        <li><a href="#sec22">USER DATA</a></li>
                        <li><a href="#sec23">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
                        <li><a href="#sec24">CALIFORNIA USERS AND RESIDENTS</a></li>
                        <li><a href="#sec25">MISCELLANEOUS</a></li>
                        <li><a href="#sec26">CONTACT US</a></li>
                    </ol>

                    {/* SECTIONS */}

                    <section id="sec1" className="mt-16">
                    ...
                    <section id="sec2" className="mt-16">
                        ...
                        <p className="mt-4">
                            If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:printlast@outlook.com">printlast@outlook.com</a>.
                        </p>
                        <p className="mt-4">
                        ...
                        <h3 className="mt-8">Your submissions</h3>
                        <p>
                    ...
                    <section id="sec3" className="mt-16">
                        <h2>3. USER REPRESENTATIONS</h2>
                        <p>
                            By using the Services, you represent and warrant that:
                        </p>
                        <ol className="list-decimal pl-6 mt-4 space-y-1.5">
                    ...
                    <section id="sec4" className="mt-16">
                    ...
                    <section id="sec5" className="mt-16">
                        <h2>5. PRODUCTS</h2>
                        <p>
                    ...
                    <section id="sec6" className="mt-16">
                        ...
                        <p className="mt-4">
                            We may, in our sole discretion, limit or cancel quantities purchased per person, per household, or per order. These restrictions may include orders placed by or under the same customer account, the same payment method, and/or orders that use the same billing or shipping address.
                        </p>
                        <p className="mt-4">
                    ...
                    <section id="sec7" className="mt-16">
                        <h2>7. RETURN POLICY</h2>
                        <p>
                            Please review our Return Policy prior to making any purchases: <a href="https://printlast.shop/refund-policy" target="_blank" rel="noopener noreferrer">https://printlast.shop/refund-policy</a>.
                        </p>
                    </section>

                    <section id="sec8" className="mt-16">
                    ...
                    <section id="sec9" className="mt-16">
                        ...
                        <p className="mt-4">
                            When you create or make available any Contributions, you thereby represent and warrant that: [full list of 12 warranties from original text preserved]
                        </p>
                        <ul className="list-disc pl-6 mt-2 space-y-1.5">
                    ...
                    {/* SECTION 10 */}
                    <section id="sec10" className="mt-16">
                    ...
                    {/* SECTION 11 */}
                    <section id="sec11" className="mt-16">
                    ...
                    {/* SECTION 12 */}
                    <section id="sec12" className="mt-16">
                    ...
                    {/* SECTION 13 */}
                    <section id="sec13" className="mt-16">
                        <h2>13. PRIVACY POLICY</h2>
                        <p>
                            We care about data privacy and security. Please review our Privacy Policy: <a href="https://printlast.shop/privacy" target="_blank" rel="noopener noreferrer">https://printlast.shop/privacy</a>.
                        </p>
                        <p className="mt-4">
                    ...
                    {/* SECTION 15 */}
                    <section id="sec15" className="mt-16">
                    ...
                    {/* SECTION 16 */}
                    <section id="sec16" className="mt-16">
                    ...
                    {/* SECTION 17 */}
                    <section id="sec17" className="mt-16">
                        ...
                        <h3 className="mt-8">Binding Arbitration</h3>
                        <p>
                        ...
                        <p className="mt-4">
                            The number of arbitrators shall be __________. The seat, or legal place, or arbitration shall be __________. The language of the proceedings shall be __________. The governing law of these Legal Terms shall be substantive law of __________.
                        </p>

                        <h3 className="mt-8">Restrictions</h3>
                        <p>
                            The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.
                        </p>

                        <h3 className="mt-8">Exceptions to Informal Negotiations and Arbitration</h3>
                        <p>
                    ...
                    {/* SECTION 18 */}
                    <section id="sec18" className="mt-16">
                    ...
                    {/* SECTION 19 */}
                    <section id="sec19" className="mt-16">
                        <h2>19. DISCLAIMER</h2>
                    ...
                    {/* SECTION 20 */}
                    <section id="sec20" className="mt-16">
                    ...
                    {/* SECTION 21 */}
                    <section id="sec21" className="mt-16">
                    ...
                    {/* SECTION 22 */}
                    <section id="sec22" className="mt-16">
                        <h2>22. USER DATA</h2>
                        <p>
                    ...
                    {/* SECTION 23 */}
                    <section id="sec23" className="mt-16">
                    ...
                    {/* SECTION 24 */}
                    <section id="sec24" className="mt-16">
                    ...
                    {/* SECTION 25 */}
                    <section id="sec25" className="mt-16">
                    ...
                    <section id="sec26" className="mt-16 pt-10 border-t border-gray-200 dark:border-gray-700">
                        <h2>26. CONTACT US</h2>
                        <p className="mt-4">
                        ...
                        <div className="mt-4 pl-6 font-medium leading-relaxed">
                            PrintLast<br />
                            8560 Florida Blvd, Baton Rouge, LA 70815<br />
                            United States<br />
                            Phone: XXXXXXXXXX<br />
                            <a href="mailto:printlast@outlook.com">printlast@outlook.com</a>
                        </div>
                    </section>
                </div>
