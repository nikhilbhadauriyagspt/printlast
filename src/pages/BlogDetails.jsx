    ...
    return (
        <div className="bg-slate-50 min-h-screen pb-32">
            <SEO 
                ...
                manualTitle={blog.meta_title || blog.title}
                manualDesc={blog.meta_description || blog.description}
                manualKeywords={blog.meta_keywords}
                image={heroImage}
                type="article"
            />
                        ...
                        <div className="flex items-center justify-center gap-8 text-white/80 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-sm font-bold text-white">{blog.author || 'printlast Editorial'}</p>
                                </div>
                            </div>
